...
class UserTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $users = array(
            ['id' => 1, 'user_id' => '201201030', 'username' => 'josepalma', 'email' => 'jpalma@yahoo.com', 'password' => bcrypt('jpalmapass'), 'firstname' => 'Jose', 'lastname' => 'Palma', 'department' => 00001, 'status' => 'Active', 'job_title' => 'Super Administrator', 'user_type' => 'Superadmin'],
